...
class Pyshark_distance():
    ...
    def _parse_ssid(self, raw_ssid):
        try:
            ...
            return ssid or '(wildcard)'
        except (ValueError, UnicodeDecodeError):
            return str(raw_ssid) # When there is an exception SSID value becomes the raw SSID in string format
    ...
    def live_data(self, interface):
        ...
        for packet in cap.sniff_continuously():
            ...
            for layer in packet.layers:
                ...
                if raw_ssid:
                    ssid = self._parse_ssid(raw_ssid)
                    break
